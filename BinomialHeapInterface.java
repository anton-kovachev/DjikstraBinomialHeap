...
public interface BinomialHeapInterface {
	...
	*
	* As this is interface we don't actually declare the field here.
	* We expect it to happen in the implementation.
	*/
	//private Node root;
	...
	* As this is abstract class it is
	*
	* As this is interface we don't actually declare the constructor here.
	* We expect it to happen in the implementation.
	*/
	//public BinomialHeap();
	...
	* Expected runneing time O(elements.length)
	...
	* It is expected that the tructure of otherHeap will be destroyed in this method.
	*
